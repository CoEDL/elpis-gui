...
class PronDictL2S extends Component {
    ...
    render() {
        ...
        const panes = [
            ...
            { menuItem: 'Bar Graph', render: () => <Tab.Pane>{<FrequencyBar dataUrl={urls.api.statistics.l2sFreq}/>}</Tab.Pane> },
            { menuItem: 'Sankey Graph', render: () => <Tab.Pane>{<SankeyWordOrder dataUrl={urls.api.statistics.sankeyGraph}/>}</Tab.Pane> },
        ]
