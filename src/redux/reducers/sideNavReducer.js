...
async function getNextStepName(stepName, engine) {

	// await i18next.loadNamespaces(['en']);
...
const initialStepModelState = {
	...
	steps: {
		engine: {
			substeps: [
				{ done: false, doing: true, enabled: true, title: "sidenav.engine", path: urls.gui.engine.index }
			],
			engine_specific: null
		},
		recordings: {
			substeps: [
				{ done: false, doing: false, enabled: false, title: "sidenav.recordings", path: urls.gui.dataset.index },
				{ done: false, doing: false, enabled: false, title: "sidenav.files", path: urls.gui.dataset.files },
				{ done: false, doing: false, enabled: false, title: "sidenav.wordlist", path: urls.gui.dataset.prepare }
			],
			engine_specific: null
		},
		pronunciation: {
			substeps: [
				{ done: false, doing: false, enabled: false, title: "sidenav.pronunciation", path: urls.gui.pronDict.index },
				{ done: false, doing: false, enabled: false, title: "sidenav.l2s", path: urls.gui.pronDict.l2s },
				{ done: false, doing: false, enabled: false, title: "sidenav.dictionary", path: urls.gui.pronDict.lexicon }
			],
			engine_specific: 'kaldi'
		},
		train: {
			substeps: [
				{ done: false, doing: false, enabled: false, title: "sidenav.training", path: urls.gui.model.index },
				{ done: false, doing: false, enabled: false, title: "sidenav.settings", path: urls.gui.model.settings },
				{ done: false, doing: false, enabled: false, title: "sidenav.train", path: urls.gui.model.train },
				{ done: false, doing: false, enabled: false, title: "sidenav.results", path: urls.gui.model.results },
			],
			engine_specific: null
		},
		transcribe: {
			substeps: [
				{ done: false, doing: false, enabled: false, title: "sidenav.new-transcriptions", path: urls.gui.transcription.new }
			],
			engine_specific: null
		}
	}
